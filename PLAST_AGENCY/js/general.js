...
let sliderSlider = new Swiper(".slider__body", {
  ...
  // Dotts
  pagination: {
    el: ".slider__navigation-paggination",
    clickable: true,
  },
  // Arrows
  navigation: {
    prevEl: ".slider__navigation-arrow_prev",
    nextEl: ".slider__navigation-arrow_next",
  },
  /*
	breakpoints: {
		320: {
...
//RANGE 
const priceSlider = document.querySelector(".product__range"); 
if (priceSlider) { 
 ...
 noUiSlider.create(priceSlider, { 
    ...
    step: 500, 
    connect: "lower", 
    // tooltips: [wNumb({ decimals: 0, postfix: "&nbsp;шт" })], 
    range: { 
      min: 500, 
      max: 5000, 
    }, 
  ...
  var inputNumber = document.getElementById('input_range'); 
